...
#Read data file
mydir = 'D:\\Projects\\FlowCytoData'
testdata1 = file.path(mydir,'16092016_rainbow med_002.fcs')
...
#Show all data
dfres1 <-hist(df$SortBucket,breaks=6, freq=TRUE,main=paste("Total bucket sorts"), col='yellow', plot=TRUE,xlab="Bucket diff",xlim=range(0,6))
...
barplot(ptable, legend=TRUE,beside=TRUE)
